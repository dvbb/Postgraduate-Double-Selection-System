		   ...
		   <div id="wrapper">
			...
			<div id="leftbar">
			 ...
			 <div id="main">
				 	...
				 	<form name="stufrm" action="../Administrator.action">
				 	...
				 	<form name="teacherfrm" action="../Administrator.action">
				 		<table align="center" border="1" style="text-align: center; width: 100%;">
							<thead>
								<tr>
									<th width="10%">教师号</th>
				 	...
				 	<font   size="6">新增学院管理员：</font><br>
				 	<form name="cadfrm" action="../Administrator.action">
				 		<table align="center" border="1" style="text-align: center; width: 100%;">
							<thead>
								<tr>
									<th width="5%">账号</th>
							...
							<tbody>
								<tr>
									<td><input  name="cano" style="width:98%;height:20px"></td>
									<td><input  name="pwd" style="width:98%;height:20px"></td>
									<td><input  name="caname" style="width:98%;height:20px"></td>
									<td><input  name="cno" style="width:98%;height:20px"></td>
								</tr>
							</tbody>
				 		</table>
				 		<input id="button" type=submit  value="确定新增">
						<input id="button" type=reset 	value="重填">
						<input  type=hidden name="func" value="add_cadmini">
				 	</form>
